...
export function Slider({ value: controlledValue, defaultValue = 50, min = 0, max = 100, step = 1, onChange, className = '', size = 'md', disabled = false }) {
    ...
    return (_jsx("div", { className: `relative ${className}`, children: _jsxs("div", { ref: sliderRef, className: `
        ...
        `, onMouseDown: handleMouseDown, children: [_jsx("div", { className: "absolute left-0 top-0 h-full bg-foreground rounded-full transition-all duration-200 ease-out", style: { width: `${percentage}%` } }), _jsx("div", { className: `
