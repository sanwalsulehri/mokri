        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="relative">
              ...
              <blockquote className="text-xl md:text-2xl font-medium text-foreground leading-relaxed max-w-3xl mx-auto">
            ...
            <div className="flex flex-col items-center space-y-2">
              <Avatar
                ...
                fallback={testimonials[currentIndex].avatar}
                size="lg"
        ...
        {showNavigation && (
          <>
            <button
              ...
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-12 bg-background/90 hover:bg-background border border-border rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 group"
            >
              <svg
            ...
            <button
              onClick={goToNext}
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-12 bg-background/90 hover:bg-background border border-border rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 group"
            >
              <svg
                className="w-5 h-5 text-foreground/70 group-hover:text-foreground transition-colors"
                fill="none"
