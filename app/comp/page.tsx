            ...
            modalContent={
              <div className="space-y-6">
                ...
                <div className="flex justify-end gap-2">
                  <Button bg={false} outline={true}>Cancel</Button>
            ...
            modalContent={
              <div className="space-y-6">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-foreground/70">We'd love to hear from you. Send us a message and we'll respond as soon as possible.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-foreground/70">hello@example.com</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-foreground/70">123 Main St, City, State 12345</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      <Input isLabel={true} label="Name" placeholder="Your name" />
                      <Input isLabel={true} label="Email" type="email" placeholder="your@email.com" />
                      <TextArea isLabel={true} label="Message" placeholder="How can we help you?" rows={4} />
                      <div className="flex justify-end gap-2">
                        <Button bg={false} outline={true}>Cancel</Button>
